// Helper: writes the new Firebase auth.js
'use strict';
const fs = require('fs');
const path = require('path');

const OUT = path.resolve(__dirname, '..', 'js', 'auth.js');
...
const src = `// ===== AUTH.JS - Firebase auth gate =====
...
(function () {
  const AUTH = {
    ...
    renderGate() {
      ...
      gate.innerHTML = ${JSON.stringify(GATE_HTML)};
...
console.log('auth.js written OK, length:', src.length);
